  ...
  if (isLoggedIn) {
    return (
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 pb-4 pt-20 overflow-y-auto bg-neutral-primary-soft border-e border-default">
          <div className="h-full flex flex-col justify-between">
            ...
            <button
              className="w-full flex items-center  px-2 py-1.5 text-red-400 rounded-base hover:bg-red-100 hover:text-red-500 group"
              onClick={handleLogOut}
            >
              <svg
                className="shrink-0 w-5 h-5 transition duration-75 text-red-400 group-hover:text-red-500"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
