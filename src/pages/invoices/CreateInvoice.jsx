...
const CreateInvoice = () => {
  return (
    <div class="p-4 sm:ml-64 mt-14">
      <div class="flex flex-col gap-5 p-4 border border-default border-dashed rounded-base">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 flex-1 bg-white border border-zinc-200 rounded-base shadow-xs p-5">
          ...
          <label className="block text-base font-medium text-gray-900 w-full">
            ...
            <div class="relative max-w-sm">
              ...
              <input
                ...
                id="issue-datepicker"
                type="text"
                class="block w-full ps-9 pe-3 py-2 bg-gray-50 border border-gray-300 text-gray-900 mt-1 focus:border-primary-600 focus:ring-brand px-3 rounded  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <div class="grid grid-cols-[1fr] xl:grid-cols-2 gap-4 flex-1">
          <div className="p-6 sm:p-8 bg-white border border-zinc-200 rounded-base shadow-xs">
            <h1 className="text-xl mb-5 font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
              Bill From
            </h1>
            <form className="space-y-3 md:space-y-5" onSubmit={undefined}>
              <div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-900 dark:text-white">
                  ...
                  <textarea
                    rows="3"
                    class="resize-none overflow-y-auto bg-gray-50 border border-gray-300 text-gray-900 mt-1 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <div class="grid grid-cols-3 gap-4 flex-1 bg-white border border-zinc-200 rounded-base shadow-xs">
              ...
              <tbody>
                <tr className="bg-neutral-primary-soft border-b border-default">
                  <td className="p-4">
                    <div class="flex items-center">
                      <input
                        ...
                        class="w-4 h-4 border border-default-medium rounded-xs bg-neutral-secondary-medium focus:ring-2 focus:ring-brand-soft"
                      />
                      <label for="table-checkbox-1" class="sr-only">
                        Table checkbox
                      </label>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <div class="relative flex items-center max-w-[10rem] bg-gray-50 text-gray-900 rounded-lg">
                      <button
                        type="button"
                        id="decrement-button"
                        data-input-counter-decrement="quantity-input"
                        class="text-body bg-neutral-secondary-medium box-border border border-gray-300 hover:bg-neutral-tertiary-medium hover:text-heading focus:ring-4 focus:ring-neutral-tertiary font-medium leading-5 rounded-s-base text-sm px-3 focus:outline-none h-10"
                      >
                        <svg
                      ...
                      <input
                        ...
                        class="border-x-0 h-10 placeholder:text-heading text-center w-full bg-neutral-secondary-medium border-gray-300 py-2.5 placeholder:text-body"
                        placeholder="0"
                        required
                      />
                      <button
                        ...
                        class="text-body bg-neutral-secondary-medium box-border border border-gray-300 hover:bg-neutral-tertiary-medium hover:text-heading focus:ring-4 focus:ring-neutral-tertiary font-medium leading-5 rounded-e-base text-sm px-3 focus:outline-none h-10"
                      >
                        <svg
                          class="w-4 h-4 text-heading"
                          aria-hidden="true"
        ...
        <div class="grid grid-cols-2 gap-6 ">
          <div class="flex items-center justify-center h-60 bg-white border border-zinc-200 rounded-base shadow-xs">
